...
public class URLShortener {
     ...
     */
        ...
        public static void main(String args[]) {
            ...
            URLShortener u2 = new URLShortener(5, "https://syrup.co.kr/io/");
            String urls2[] = {"https://syrup.co.kr/web-event/event-winning-history.html?eventId=000050"};
            for (int i = 0; i < urls2.length; i++) {
                System.out.println("URL:" + urls2[i] + "\tTiny: "
                        + u2.shortenURL(urls2[i]) + "\tExpanded: "
                        + u2.expandURL(u2.shortenURL(urls2[i])));
            }
    }
}
