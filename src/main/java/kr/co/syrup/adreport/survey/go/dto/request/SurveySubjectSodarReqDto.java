...
@NoArgsConstructor
@Data
public class SurveySubjectSodarReqDto implements Serializable {

    private static final long serialVersionUID = -7607407961390367935L;
    ...
    //주관식 정답 정보
    private List<SurveyExampleQuestionSodarReqDto> exampleQuestionInfo;
