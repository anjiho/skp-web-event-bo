...
public class AdvertisementApplyDto implements Serializable {

    private static final long serialVersionUID = 4449021883944720429L;

    @ApiModelProperty(value = "광고 신청 ID")
