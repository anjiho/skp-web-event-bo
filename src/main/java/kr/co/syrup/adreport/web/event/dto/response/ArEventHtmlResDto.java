...
@AllArgsConstructor
@Data
public class ArEventHtmlResDto {
    ...
    //html 버튼 'event_btn' 클래스의 name 명 지정 값
    private String eventBtnName;
    ...
    List<ArEventNftBannerEntity> arEventNftBannerInfo;

    //디바이스 위치정보
    private List<EventDeviceGpsResDto> arEventDeviceGpsInfo;
}
