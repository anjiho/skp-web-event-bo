...
@AllArgsConstructor
@Data
public class SurveySubjectResDto implements Serializable {

    private static final long serialVersionUID = -1965402239038226860L;
    ...
    private List<SurveyExampleEntity> exampleInfo;

    private List<SurveyExampleQuestionEntity> exampleQuestionInfo;

    private List<SurveySubjectPopupImageEntity> popupImageInfo;
}
