...
@Setter
@Getter
public class EventHtmlDto implements Serializable {

    private static final long serialVersionUID = -625745687623018068L;
    ...
    //NFT 배너 정보
    private List<NftBannerReqDto> arEventNftBannerInfo;

    //디바이스 위치정보
    private List<EventDeviceGpsReqDto> arEventDeviceGpsInfo;
